  ...
  return (
    <footer className="mt-16 border-t border-hairline bg-background">
      <div className="mx-auto max-w-[1440px] px-6 py-12">
        <div className="grid gap-14 md:grid-cols-12">
          <div className="md:col-span-4">
            <Link to="/" className="block">
              <span className="font-display text-2xl tracking-[0.32em] text-gold-secondary">KANZU BAY</span>
            </Link>
          ...
          <FooterCol title="Shop" items={[{ label: "Thobes", to: "/shop", search: { category: "Thobes" } }, "Headwear", "Watches", "Sandals", "Tasbih"]} />
          ...
          <div className="md:col-span-3">
            ...
            <form className="mt-4 flex border-b border-ink/80">
              <input
                type="email"
        ...
        <div className="mt-10 flex flex-col items-start justify-between gap-4 border-t border-hairline pt-6 text-[11px] uppercase tracking-[0.2em] text-muted-foreground md:flex-row md:items-center">
