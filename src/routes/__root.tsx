...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Kanzu Bay is East Africa's Premium Men's Islamic Fashion House. Premium Saudi Thobes, Emirati Kanzu, Omani Kanzu, Swahili Kanzu, perfumes, and lifestyle accessories." },
      { name: "author", content: "Kanzu Bay" },
      { property: "og:title", content: "Kanzu Bay — East Africa's Premium Men's Islamic Fashion House" },
      { property: "og:description", content: "Premium Men's Islamic Fashion. Saudi Thobes, Emirati Kanzu, Omani Kanzu, Swahili Kanzu, perfumes, and lifestyle accessories." },
